...
@Component({
  ...
  standalone: true,
  imports: [AgGridAngular , CommonModule , PaginationComponent , FormsModule , ReactiveFormsModule , NgSelectModule , ButtonComponent],
...
export class CaseListComponent {
  ...
  isFormCollapsed = true;
    ...
    //     pageNo : 1,
    //     pageSize : 999999,
    //     AdmDeptId : this.caseFilterForm.value.AdmDeptId ? this.caseFilterForm.value.AdmDeptId : 0,
    //     UnitId : this.caseFilterForm.value.UnitId ? this.caseFilterForm.value.UnitId : 0,
    //     DistrictId : this.caseFilterForm.value.DistrictId ? this.caseFilterForm.value.DistrictId : 0,
    //     ActiveFilter : Number(this.caseFilterForm.value.ActiveFilter)
    //   }
    ...
    exportPDF() {
      ...
      // this.excel.exportAllJsonPDF(headers, columns, this.caseList, 'caseList', true);
    }
}
