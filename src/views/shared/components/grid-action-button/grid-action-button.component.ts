...
export class GridActionButtonComponent implements ICellRendererAngularComp {
  ...
  delete() { this.params.delete(this.params.data); }
  edit()   { this.params.edit(this.params.data); }
  permissionMappingApprove() { this.params.permissionMappingApprove(this.params.data); }
}